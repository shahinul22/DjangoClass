...
urlpatterns = [
    ...
    path(
        "courses/edit/<int:course_id>/", views.edit_course, name="edit_course"
    ),  # Add this URL
    path("courses/add/", views.add_course, name="add_course"),
    # path('courses/delete/<int:course_id>/', views.delete_course, name='delete_course'),
    path(
        "course/<int:id>/delete/",
        views.delete_course_confirm,
        name="delete_course_confirm",
    ),
    # Lesson URLs
    ...
    path(
        "delete_lesson_confirm/<int:lesson_id>/",
        views.delete_lesson_confirm,
        name="delete_lesson_confirm",
    ),
    # enroll urls
    path("enroll/", views.enroll_student, name="enroll_student"),
    path(
        "course/<int:course_id>/enrolled/",
        views.view_enrolled_students,
